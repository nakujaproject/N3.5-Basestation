...
simulated_parameter = velocity;  % data with noise
...
figure;
plot(1:rows, filtered_parameter, '-b', 1:rows, velocity, '-r')
xlabel('Time Step');
ylabel('Velocity');
legend('filtered velocity', 'raw velocity')
title('Kalman Filtered Velocity');
grid on;